...
REAFINER_ACTION_USER_PROMPT = """Given the Original Text:
{original_text}

Using the original question, accumulated KG context, and the abduction immediately above, generate the graph refinement actions.
"""
